...
GrowthSW <- GrowthSW %>% mutate(if_else(revolutions == 0, "revolutions equal to 0", "revolutions greater than 0" ))

GrowthSW <- GrowthSW %>% rename('treat' = 'if_else(revolutions == 0, "revolutions equal to 0", "revolutions greater than 0")')
